...
(function initEnvironmentStack() {

  const images =
    document.querySelectorAll('.environment-slider img');
  ...
  images[next].style.zIndex =
    Number(images[previous].style.zIndex || 10) + 1;
...
const darkSections = document.querySelectorAll(
  '.timeline, .statement,.site-footer, .admission, .environment'
);
...
const slider = document.querySelector('.courses__grid');
